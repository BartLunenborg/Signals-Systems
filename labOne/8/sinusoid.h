...
/**
 * Find the fundamental period of n Sinusoid whose sum is periodic
 * @param sinusoids  The array of Sinusoid
 * @param n          The size of the array
 * @return           The fundamental period
 */
int fundamentalPeriod(Sinusoid* sinusoids, int n);
